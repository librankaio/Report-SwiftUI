...
@section('page-script')
    <script>
        const mutasibhnbakuUrl = "{{ route('mutasibhnbakudata') }}";
    </script>
    <script type="module" src="{{ asset('assets/js/page-mutasibhnbaku.js') }}"></script>
@endsection

@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Report /</span> Mutasi Bahan Baku
    </h4>
    <div class="row">
        <!-- Form controls -->
        <div class="col-md-6">
