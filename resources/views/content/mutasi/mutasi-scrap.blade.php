...
@section('page-script')
    <script>
        const mutasiscrapUrl = "{{ route('mutasiscrapdata') }}";
    </script>
    <script type="module" src="{{ asset('assets/js/page-mutasiscrap.js') }}"></script>
@endsection

@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Report /</span> Mutasi Scrap
    </h4>
    <div class="row">
        <!-- Form controls -->
        <div class="col-md-6">
