    ...
    <div class="row gy-4 mb-4">
            ...
            <div class="card h-100">
                <div class="card-header">
                    ...
                    <div class="d-flex align-items-center">
                        <small class="me-2 text-body">Total 42.5k Sales</small>
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <div class="card-info">
                        <p class="mb-2">Total Sales This Month</p>
                        ...
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    ...
                                    <p class="mb-0 fw-medium">John Doe (Client)</p>
                                </div>
                            </div>
                        </li>
                    ...
                    <div class="row d-flex align-items-center">
                        <div class="col-5 col-lg-6 col-xl-5">
                            <div class="chart-progress" data-color="primary" data-series="70"
                                data-icon="{{ asset('assets/img/icons/misc/card-icon-laptop.png') }}"></div>
                        </div>
                    ...
                    <div class="row d-flex align-items-center">
                        <div class="col-5 col-lg-6 col-xl-5">
                            <div class="chart-progress" data-color="warning" data-series="40"
                                data-icon="{{ asset('assets/img/icons/misc/card-icon-bag.png') }}"></div>
                        </div>
                        <div class="col-7 col-lg-6 col-xl-7">
                            <div class="card-info">
                                <div class="d-flex align-items-center gap-2 flex-wrap">
        ...
        <div class="col-lg-4 col-sm-6 order-sm-2 order-lg-0">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <small class="text-body">Total 890 Visitors Are Live</small>
                </div>
                <div class="card-body pt-0">
        ...
        <div class="col-lg-8 col-12">
            <div class="card ">
                <div class="table-responsive rounded-3">
                    <table class="datatables-ecommerce table">
